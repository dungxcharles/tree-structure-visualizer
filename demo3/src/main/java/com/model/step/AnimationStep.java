...
/**
 * Một "dòng ghi chép" lưu lại một hành động cụ thể tại một thời điểm của thuật toán.
...
public class AnimationStep {
    ...
    // mainNodeValue là giá trị của node chính đang được thao tác (ví dụ: node đang xét, node mới được thêm vào, node bị xóa đi, v.v.)
    // message là một chuỗi mô tả ngắn gọn về hành động này, có thể dùng để hiển thị trên giao diện hoặc để debug. Ví dụ: "So sánh 5 với 3", "Đi sang trái", "Thêm node 7 vào cây
